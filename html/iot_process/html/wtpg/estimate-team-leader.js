...
$.ajax({  
	...
	url : url+"iot_process/userOrganizationTree/userOrganizationArea",  
	type : "get",
	//$.cookie("organ")$.cookie("name")
	//data : {area:$.cookie("organ"),username:$.cookie("name")},
	data : {area:organ,username:user_name},
							...
							offset: function(othis){
								...
								,yes: function(){
									...
									for (var i = 0; i < check.length; i++) {
										usernames += userOrDept(check[i].id);
...
$.ajax({  
	...
	type : "get",
	//$.cookie("organ")$.cookie("name")
	data : {organ:organ,username:user_name},
	dataType : "json",  
	success: function( json) {
		var coordinate_tree_data=[];
		var coordinate_tree;
